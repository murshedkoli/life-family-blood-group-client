...
const DonerForHome = ({ doner }) => {
    ...
    return (
        <div >
            <div style={{ backgroundColor: 'rgb(0 0 139 / 74%)', color: '#fff' }} class="card mt-3">
                ...
                <div class="row card-body d-flex">
                    ...
                    <div className="col-md-6 col-sm-12" >
                        <Link style={{ color: 'white', fontWeight: 'bold', textDecoration: 'none' }} to={`singleDoner/${doner._id}`}><h5 style={{ textTransform: 'capitalize' }} class="card-title">{doner.name}</h5></Link>
